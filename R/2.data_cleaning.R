...
ROI_global <- merge.data.frame(ROI_tumor, ROI_stroma,
  ...
  mutate(CD3perc_tumor_mm2 = (`tumor__%_cd3__opal_650__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD3perc_stroma_mm2 = (`stroma__%_cd3__opal_650__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD3_CD8perc_tumor_mm2 = (`tumor__%_cd3__cd8__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD3_CD8perc_stroma_mm2 = (`stroma__%_cd3__cd8__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD3_FoxP3perc_tumor_mm2 = (`tumor__%_cd3__foxp3__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD3_FoxP3perc_stroma_mm2 = (`stroma__%_cd3__foxp3__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD11bperc_tumor = (`tumor__%_cd11b__opal_620__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD11bperc_stroma = (`stroma__%_cd11b__opal_620__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD11b_CD15perc_tumor_mm2 = (`tumor__%_cd11b__cd15__positive_cells`/tumor__area_analyzed__mm__)) %>% 
  mutate(CD11b_CD15perc_stroma_mm2 = `stroma__%_cd11b__cd15__positive_cells`/tumor__area_analyzed__mm__)
