...
**Part 1 without adjusting for debulking (just removing patients)**
...
<span style="color: white;"> Part 2 From here all analysis are adjusted by debulking CA125</span>
...
# HR interaction terms by race Adjusted dblkstat_CA125 + stage + refage + race + CD3*race
Cross product interaction terms between race and the immune markers group.  
