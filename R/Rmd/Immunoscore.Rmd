...
clinical_data <- clinical_data %>% 
  ...
  mutate(vitalstatus_new = case_when(
...
An average percentile is calculated based on these 4 values. **The Immunoscore® is **
