...
## Correlation for the 28 common patients between TMA and ROI
```{r}
...
A first correlation plot with all immune markers:
...
For more lisibility I separated CD3/CD8/FoxP3 and CD11b/CD15:
