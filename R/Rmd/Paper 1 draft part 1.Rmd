...
markers_ROI <- markers_ROI %>% 
  ...
  ), CD3_tumor.i = factor(CD3_tumor.i, levels = c("zero","low","high > 1.11%"))) %>% 
  ...
  ), CD3_CD8_tumor.i = factor(CD3_CD8_tumor.i, levels = c("zero","low","high > 0.46%"))) %>% 
  ...
  ), CD3_FoxP3_tumor.i = factor(CD3_FoxP3_tumor.i, levels = c("zero","low","high > 0.19%"))) %>% 
  ...
  mutate(CD11b_tumor.i3 = case_when(
    percent_CD11b_tumor.i == 0       ~ "zero",
    percent_CD11b_tumor.i <= median(percent_CD11b_tumor.i[percent_CD11b_tumor.i>0])      ~ "low",
    percent_CD11b_tumor.i > median(percent_CD11b_tumor.i[percent_CD11b_tumor.i>0])       ~ "high"
  ), CD11b_tumor.i3 = factor(CD11b_tumor.i3, levels = c("zero","low","high"))) %>% 
  mutate(CD11b_CD15_tumor.i3 = case_when(
    percent_CD11b_CD15_tumor.i == 0       ~ "zero",
    percent_CD11b_CD15_tumor.i <= median(percent_CD11b_CD15_tumor.i[percent_CD11b_CD15_tumor.i>0])      ~ "low",
    percent_CD11b_CD15_tumor.i > median(percent_CD11b_CD15_tumor.i[percent_CD11b_CD15_tumor.i>0])       ~ "high"
  ), CD11b_CD15_tumor.i3 = factor(CD11b_CD15_tumor.i3, levels = c("zero","low","high"))) %>% 
  ...
  ), CD3_stroma.i = factor(CD3_stroma.i, levels = c("zero","low","high > 4.17%"))) %>% 
  ...
  ), CD3_CD8_stroma.i = factor(CD3_CD8_stroma.i, levels = c("zero","low","high > 1.46%"))) %>% 
  ...
  ), CD3_FoxP3_stroma.i = factor(CD3_FoxP3_stroma.i, levels = c("zero","low","high > 0.78%"))) %>% 
  ...
  mutate(CD11b_stroma.i3 = case_when(
    percent_CD11b_stroma.i == 0       ~ "zero",
    percent_CD11b_stroma.i <= median(percent_CD11b_stroma.i[percent_CD11b_stroma.i>0])      ~ "low",
    percent_CD11b_stroma.i > median(percent_CD11b_stroma.i[percent_CD11b_stroma.i>0])       ~ "high"
  ), CD11b_stroma.i3 = factor(CD11b_stroma.i3, levels = c("zero","low","high"))) %>%
  mutate(CD11b_CD15_stroma.i3 = case_when(
    percent_CD11b_CD15_stroma.i == 0       ~ "zero",
    percent_CD11b_CD15_stroma.i <= median(percent_CD11b_CD15_stroma.i[percent_CD11b_CD15_stroma.i>0])      ~ "low",
    percent_CD11b_CD15_stroma.i > median(percent_CD11b_CD15_stroma.i[percent_CD11b_CD15_stroma.i>0])       ~ "high"
  ), CD11b_CD15_stroma.i3 = factor(CD11b_CD15_stroma.i3, levels = c("zero","low","high"))) %>% 
  ...
  ), CD3_total.i = factor(CD3_total.i, levels = c("zero","low","high > 1.46%"))) %>% 
  ...
  ), CD3_CD8_total.i = factor(CD3_CD8_total.i, levels = c("zero","low","high > 0.56%"))) %>% 
  ...
  ), CD3_FoxP3_total.i = factor(CD3_FoxP3_total.i, levels = c("zero","low","high > 0.23%"))) %>% 
  ...
  mutate(CD11b_total.i3 = case_when(
    percent_CD11b_total.i == 0       ~ "zero",
    percent_CD11b_total.i <= median(percent_CD11b_total.i[percent_CD11b_total.i>0])      ~ "low",
    percent_CD11b_total.i > median(percent_CD11b_total.i[percent_CD11b_total.i>0])       ~ "high"
  ), CD11b_total.i3 = factor(CD11b_total.i3, levels = c("zero","low","high"))) %>% 
  mutate(CD11b_CD15_total.i3 = case_when(
    percent_CD11b_CD15_total.i == 0       ~ "zero",
    percent_CD11b_CD15_total.i <= median(percent_CD11b_CD15_total.i[percent_CD11b_CD15_total.i>0])      ~ "low",
    percent_CD11b_CD15_total.i > median(percent_CD11b_CD15_total.i[percent_CD11b_CD15_total.i>0])       ~ "high"
  ), CD11b_CD15_total.i3 = factor(CD11b_CD15_total.i3, levels = c("zero","low","high"))) %>% 
  ...
  ), CD3_tumor.p = factor(CD3_tumor.p, levels = c("zero","low","high > 1.98%"))) %>% 
  ...
  ), CD3_CD8_tumor.p = factor(CD3_CD8_tumor.p, levels = c("zero","low","high > 0.94%"))) %>% 
  ...
  ), CD3_FoxP3_tumor.p = factor(CD3_FoxP3_tumor.p, levels = c("zero","low","high > 0.35%"))) %>% 
  ...
  mutate(CD11b_tumor.p3 = case_when(
    percent_CD11b_tumor.p == 0       ~ "zero",
    percent_CD11b_tumor.p <= median(percent_CD11b_tumor.p[percent_CD11b_tumor.p>0])      ~ "low",
    percent_CD11b_tumor.p > median(percent_CD11b_tumor.p[percent_CD11b_tumor.p>0])         ~ "high"
  ), CD11b_tumor.p3 = factor(CD11b_tumor.p3, levels = c("zero","low","high"))) %>% 
  mutate(CD11b_CD15_tumor.p3 = case_when(
    percent_CD11b_CD15_tumor.p == 0       ~ "zero",
    percent_CD11b_CD15_tumor.p <= median(percent_CD11b_CD15_tumor.p[percent_CD11b_CD15_tumor.p>0])      ~ "low",
    percent_CD11b_CD15_tumor.p > median(percent_CD11b_CD15_tumor.p[percent_CD11b_CD15_tumor.p>0])       ~ "high"
  ), CD11b_CD15_tumor.p3 = factor(CD11b_CD15_tumor.p3, levels = c("zero","low","high"))) %>% 
  ...
  ), CD3_stroma.p = factor(CD3_stroma.p, levels = c("zero","low","high > 8.31%"))) %>% 
  ...
  ), CD3_CD8_stroma.p = factor(CD3_CD8_stroma.p, levels = c("zero","low","high > 2.85%"))) %>% 
  ...
  ), CD3_FoxP3_stroma.p = factor(CD3_FoxP3_stroma.p, levels = c("zero","low","high > 0.60%"))) %>% 
  ...
  mutate(CD11b_CD15_stroma.p = case_when(
    ...
    percent_CD11b_stroma.p == 0       ~ "zero",
    percent_CD11b_stroma.p <= median(percent_CD11b_stroma.p[percent_CD11b_stroma.p>0])      ~ "low",
    percent_CD11b_stroma.p > median(percent_CD11b_stroma.p[percent_CD11b_stroma.p>0])       ~ "high"
  ), CD11b_stroma.p3 = factor(CD11b_stroma.p3, levels = c("zero","low","high"))) %>% 
  mutate(CD11b_CD15_stroma.p3 = case_when(
    percent_CD11b_CD15_stroma.p == 0       ~ "zero",
    percent_CD11b_CD15_stroma.p <= median(percent_CD11b_CD15_stroma.p[percent_CD11b_CD15_stroma.p>0])      ~ "low",
    percent_CD11b_CD15_stroma.p > median(percent_CD11b_CD15_stroma.p[percent_CD11b_CD15_stroma.p>0])       ~ "high"
  ), CD11b_CD15_stroma.p3 = factor(CD11b_CD15_stroma.p3, levels = c("zero","low","high"))) %>% 
  ...
  ), CD3_total.p = factor(CD3_total.p, levels = c("zero","low","high > 5.64%"))) %>% 
  ...
  ), CD3_CD8_total.p = factor(CD3_CD8_total.p, levels = c("zero","low","high > 2.03%"))) %>% 
  ...
  ), CD3_FoxP3_total.p = factor(CD3_FoxP3_total.p, levels = c("zero","low","high > 0.47%"))) %>% 
  ...
  mutate(CD11b_total.p3 = case_when(
    percent_CD11b_total.p == 0       ~ "zero",
    percent_CD11b_total.p <= median(percent_CD11b_total.p[percent_CD11b_total.p>0])      ~ "low",
    percent_CD11b_total.p > median(percent_CD11b_total.p[percent_CD11b_total.p>0])       ~ "high"
  ), CD11b_total.p3 = factor(CD11b_total.p3, levels = c("zero","low","high"))) %>% 
  mutate(CD11b_CD15_total.p3 = case_when(
    percent_CD11b_CD15_total.p == 0       ~ "zero",
    percent_CD11b_CD15_total.p <= median(percent_CD11b_CD15_total.p[percent_CD11b_CD15_total.p>0])      ~ "low",
    percent_CD11b_CD15_total.p > median(percent_CD11b_CD15_total.p[percent_CD11b_CD15_total.p>0])       ~ "high"
  ), CD11b_CD15_total.p3 = factor(CD11b_CD15_total.p3, levels = c("zero","low","high"))) 
...
## 2.Cluster with a non-defined number of cluster **Yes 5 is the best for when looking at all intra/periph + tumor/stroma (CD3, CD8, CD3/8, FoxP3, CD3/FoxP3, CD11b, CD15, CD11b/15)**
...
markers_ROI_o <- markers_ROI %>% 
  rename(CD3 = CD3_total.i, CD3_CD8 = CD3_CD8_total.i,
         ...
         CD11b_3 = CD11b_total.i3, CD11b_CD15_3 = CD11b_CD15_total.i3)
...
tbl6 <- coxph(Surv(time = markers_ROI$timelastfu_new, 
                   event = markers_ROI$surv_vital) ~ CD11b_3 + stage + refage + race, data =  markers_ROI_o) %>%
  tbl_regression(exponentiate = TRUE,
                 include = CD11b_3) %>% bold_p(t = .05) %>% add_nevent(location = "level")
tbl7 <- coxph(Surv(time = markers_ROI$timelastfu_new, 
                   event = markers_ROI$surv_vital) ~ CD11b_CD15_3 + stage + refage + race, data =  markers_ROI_o) %>%
  tbl_regression(exponentiate = TRUE,
                 include = CD11b_CD15_3) %>% bold_p(t = .05) %>% add_nevent(location = "level")
tbl10 <- tbl_stack(list(tbl1, tbl2, tbl3, tbl4, tbl5, tbl6, tbl7))
...
markers_ROI_t <- markers_ROI %>% 
  rename(CD3 = CD3_tumor.i, CD3_CD8 = CD3_CD8_tumor.i,
         ...
         CD11b_3 = CD11b_tumor.i3, CD11b_CD15_3 = CD11b_CD15_tumor.i3)
...
tbl7 <- coxph(Surv(time = markers_ROI$timelastfu_new, 
  ...
  tbl_regression(exponentiate = TRUE,
                 include = CD11b_CD15_3) %>% bold_p(t = .05) %>% add_nevent(location = "level")
tbl11 <- tbl_stack(list(tbl1, tbl2, tbl3, tbl4, tbl5, tbl6, tbl7))
...
markers_ROI_s <- markers_ROI %>% 
  rename(CD3 = CD3_stroma.i, CD3_CD8 = CD3_CD8_stroma.i,
         ...
         CD11b_3 = CD11b_stroma.i3, CD11b_CD15_3 = CD11b_CD15_stroma.i3)
...
tbl7 <- coxph(Surv(time = markers_ROI$timelastfu_new, 
  ...
  tbl_regression(exponentiate = TRUE,
                 include = CD11b_CD15_3) %>% bold_p(t = .05) %>% add_nevent(location = "level")
tbl12 <- tbl_stack(list(tbl1, tbl2, tbl3, tbl4, tbl5, tbl6, tbl7))
...
markers_ROI_o <- markers_ROI %>% 
  rename(CD3 = CD3_total.p, CD3_CD8 = CD3_CD8_total.p,
         ...
         CD11b_3 = CD11b_total.p3, CD11b_CD15_3 = CD11b_CD15_total.p3)
...
tbl7 <- coxph(Surv(time = markers_ROI$timelastfu_new, 
  ...
  tbl_regression(exponentiate = TRUE,
                 include = CD11b_CD15_3) %>% bold_p(t = .05) %>% add_nevent(location = "level")
tbl13 <- tbl_stack(list(tbl1, tbl2, tbl3, tbl4, tbl5, tbl6, tbl7))
...
markers_ROI_t <- markers_ROI %>% 
  rename(CD3 = CD3_tumor.p, CD3_CD8 = CD3_CD8_tumor.p,
         ...
         CD11b_3 = CD11b_tumor.p3, CD11b_CD15_3 = CD11b_CD15_tumor.p3)
...
tbl7 <- coxph(Surv(time = markers_ROI$timelastfu_new, 
  ...
  tbl_regression(exponentiate = TRUE,
                 include = CD11b_CD15_3) %>% bold_p(t = .05) %>% add_nevent(location = "level")
tbl14 <- tbl_stack(list(tbl1, tbl2, tbl3, tbl4, tbl5, tbl6, tbl7))
...
markers_ROI_s <- markers_ROI %>% 
  rename(CD3 = CD3_stroma.p, CD3_CD8 = CD3_CD8_stroma.p,
         ...
         CD11b_3 = CD11b_stroma.p3, CD11b_CD15_3 = CD11b_CD15_stroma.p3)
...
tbl7 <- coxph(Surv(time = markers_ROI$timelastfu_new, 
  ...
  tbl_regression(exponentiate = TRUE,
                 include = CD11b_CD15_3) %>% bold_p(t = .05) %>% add_nevent(location = "level")
tbl15 <- tbl_stack(list(tbl1, tbl2, tbl3, tbl4, tbl5, tbl6, tbl7))
# tbl14 <- tbl_merge(list(tbl13, tbl14, tbl15), tab_spanner = c("**Overall**", "**Tumor**", "**Stroma**"))
```

## Overall
```{r}
tbl16 <- tbl_stack(list(tbl10, tbl13), group_header = c("Intratumoral", "Peripheral"))
tbl16
```

## Tumor
```{r}
tbl17 <- tbl_stack(list(tbl11, tbl14), group_header = c("Intratumoral", "Peripheral"))
tbl17
```

# Stroma
```{r}
tbl17 <- tbl_stack(list(tbl12, tbl15), group_header = c("Intratumoral", "Peripheral"))
tbl17
