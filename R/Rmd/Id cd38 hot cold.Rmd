...
# Find Ids within cold and hot CD3 CD8
***
...
clust_markers <- clust_markers %>% 
  mutate(selected = case_when(
    str_detect(suid, "48226|180038|310110|161020|43162|110304|130223|190153|47142|41502|43906|46883|130138|150102|310254|42260|47927|42129|42286|47965") ~ "selected"
))
```
...
print(paste("ids for cold", "48226|180038|310110|161020|43162|110304|130223|190153|47142|41502"))

plot <- clust_markers %>% filter(clusters_CD38 == "low") %>% 
  mutate(text = paste("suid: ", suid, "\npercent_CD3_CD8_tumor.i: ", round(percent_CD3_CD8_tumor.i, 3),
                      "\nclusters_CD38: ", clusters_CD38, sep="")) %>% 
  ggplot(aes(x = clusters_CD38, y = percent_CD3_CD8_tumor.i, color = selected, text=text))+
...
clust_markers %>% filter(clusters_CD38 == "low") %>% select(suid, percent_CD3_CD8_tumor.i)

print(paste("ids for high", "43906|46883|130138|150102|310254|42260|47927|42129|42286|47965"))

plot <- clust_markers %>% filter(clusters_CD38 == "high") %>% 
  mutate(text = paste("suid: ", suid, "\npercent_CD3_CD8_tumor.i: ", round(percent_CD3_CD8_tumor.i, 3),
                      "\nclusters_CD38: ", clusters_CD38, sep="")) %>% 
  ggplot(aes(x = clusters_CD38, y = percent_CD3_CD8_tumor.i, color = selected, text=text))+
  geom_jitter(shape=16)+
...
clust_markers %>% filter(clusters_CD38 == "high") %>% select(suid, percent_CD3_CD8_tumor.i)
