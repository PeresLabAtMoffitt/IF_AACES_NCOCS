...
tbl <- ROI_global %>% 
  ...
  add_overall() %>% bold_labels() %>% add_p() %>% bold_p(t = .05) %>% as_flextable()
tbl
...
tbl10 <- tbl_stack(list(tbl4, tbl8, tbl9), group_header = c("Tumor", "Stroma", "Overall")) %>% as_flextable() #%>% 
tbl10
...
#   # modify_spanning_header(everything() ~ "Overall (tmor+stroma) ROIs") %>% as_flextable() #%>% 
# tbl
```
<br>
...
## Overall
```{r}
tbl16 <- tbl_stack(list(tbl10, tbl13), group_header = c("Intratumoral", "Peripheral")) %>% as_flextable() #%>% 
tbl16
...
## Tumor
```{r}
tbl17 <- tbl_stack(list(tbl11, tbl14), group_header = c("Intratumoral", "Peripheral")) %>% as_flextable() #%>% 
tbl17
...
## Stroma
```{r}
tbl18 <- tbl_stack(list(tbl12, tbl15), group_header = c("Intratumoral", "Peripheral")) %>% as_flextable() #%>% 
tbl18
...
### Overall
```{r}
tbl16 <- tbl_stack(list(tbl1, tbl4), group_header = c("Intratumoral", "Peripheral")) %>% as_flextable() #%>% 
tbl16
# #gt::gtsave(tbl16, paste0(path, "/Table Frequency distribution of the number of cases Overall group.pdf"))
```
...
### Tumor
```{r}
tbl17 <- tbl_stack(list(tbl2, tbl5), group_header = c("Intratumoral", "Peripheral")) %>% as_flextable() #%>% 
tbl17
# #gt::gtsave(tbl17, paste0(path, "/Table Frequency distribution of the number of cases Tumor group.pdf"))
```
...
### Stroma
```{r}
tbl18 <- tbl_stack(list(tbl3, tbl6), group_header = c("Intratumoral", "Peripheral")) %>% as_flextable() #%>% 
tbl18
# #gt::gtsave(tbl18, paste0(path, "/Table Frequency distribution of the number of cases Stroma group.pdf"))
```
<br>
