...
icc_overall <- fct_icc(icc_overall) %>% rename(Overall = "ICC_lb_up")
icc_intrat <- fct_icc(icc_intrat) %>% rename(Intratumoral = "ICC_lb_up")
icc_periph <- fct_icc(icc_periph) %>% rename(Peripheral = "ICC_lb_up")
