...
legend(0.83, 0.95, # right, up
       ...
       bty = "n")
legend(0.72, 1, # right, up
       legend = c("low", "mid-low", "mid", "mid-high", "high"),
       fill = c("steelblue1", "red", "black", "grey", "tan1"), cex = 0.6,
       bty = "n")
...
df1 <- as.data.frame(markers_ROI[,c("percent_CD3_tumor.i", "percent_CD3_CD8_tumor.i", "percent_CD3_FoxP3_tumor.i", 
                                    ...
                                    "percent_CD11b_stroma.i", "percent_CD11b_CD15_stroma.i",
                                    "suid", "race", "clusters_all_IandP")]) %>% 
  summarize(CD3T = median(percent_CD3_tumor.i),
            CD38T = median(percent_CD3_CD8_tumor.i),
            CD3FOXT = median(percent_CD3_FoxP3_tumor.i),
            CD11T = median(percent_CD11b_tumor.i),
            CD1115T = median(percent_CD11b_CD15_tumor.i),
            CD3S = median(percent_CD3_stroma.i),
            CD38S = median(percent_CD3_CD8_stroma.i),
            CD3FOXS = median(percent_CD3_FoxP3_stroma.i),
            CD11S = median(percent_CD11b_stroma.i),
            CD1115S = median(percent_CD11b_CD15_stroma.i),
            ) %>% 
  bind_cols(as.data.frame(markers_ROI[,c("percent_CD3_tumor.i", "percent_CD3_CD8_tumor.i", "percent_CD3_FoxP3_tumor.i", 
                                    "percent_CD11b_tumor.i", "percent_CD11b_CD15_tumor.i",
                                    "percent_CD3_stroma.i", "percent_CD3_CD8_stroma.i", "percent_CD3_FoxP3_stroma.i",
                                    "percent_CD11b_stroma.i", "percent_CD11b_CD15_stroma.i",
                                    "suid", "race", "clusters_all_IandP")])) %>% 
  
  mutate(percent_CD3_tumor.i = (percent_CD3_tumor.i - median(CD3T, na.rm = TRUE))) %>% 
  mutate(percent_CD3_CD8_tumor.i = (percent_CD3_CD8_tumor.i - median(CD38T, na.rm = TRUE))) %>% 
  mutate(percent_CD3_FoxP3_tumor.i = (percent_CD3_FoxP3_tumor.i - median(CD3FOXT, na.rm = TRUE))) %>% 
  mutate(percent_CD11b_tumor.i = (percent_CD11b_tumor.i - median(CD11T, na.rm = TRUE))) %>% 
  mutate(percent_CD11b_CD15_tumor.i = (percent_CD11b_CD15_tumor.i - median(CD1115T, na.rm = TRUE))) %>% 
  mutate(percent_CD3_stroma.i = (percent_CD3_stroma.i - median(CD3S, na.rm = TRUE))) %>% 
  mutate(percent_CD3_CD8_stroma.i = (percent_CD3_CD8_stroma.i - median(CD38S, na.rm = TRUE))) %>% 
  mutate(percent_CD3_FoxP3_stroma.i = (percent_CD3_FoxP3_stroma.i - median(CD3FOXS, na.rm = TRUE))) %>% 
  mutate(percent_CD11b_stroma.i = (percent_CD11b_stroma.i - median(CD11S, na.rm = TRUE))) %>% 
  mutate(percent_CD11b_CD15_stroma.i = (percent_CD11b_CD15_stroma.i - median(CD1115S, na.rm = TRUE))) %>% 
...
```{r}
markers_ROI %>% 
  select(percent_CD11b_total.i, percent_CD11b_tumor.i, percent_CD11b_stroma.i,
         percent_CD11b_total.p, percent_CD11b_tumor.p, percent_CD11b_stroma.p#,
         # race
         ) %>% 
  tbl_summary(#by = race,
...
markers_ROI %>% 
  select(
         CD11b_total.i, CD11b_tumor.i, CD11b_stroma.i, 
         CD11b_total.p, CD11b_tumor.p, CD11b_stroma.p#, 
         # race
         ) %>% 
