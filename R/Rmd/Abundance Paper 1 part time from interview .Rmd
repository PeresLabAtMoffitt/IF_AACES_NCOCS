...
# heatmap.2(df5, breaks = breaks, col = col, trace = "none")
Heatmap(df5, name = " ",
...
column_ho = HeatmapAnnotation(race = c(markers_ROI$race),
                              clus = (markers_ROI$clusters_all_IandP), 
                              col = list(foo = c("low" = "red", "high" = "green",
                                                 "mid" = "blue", "mid-low"= "orange", 
                                                 "mid_high"= "pink")),
    na_col = "black")
Heatmap(df5, name = " ",
        cluster_rows = FALSE, cluster_columns = FALSE,
