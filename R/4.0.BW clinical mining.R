...
# per stage----
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~stage + race, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
...
# Per behavior
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~behavior + race, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
...
# Per grade
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~grade + race, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
...
# Per histotype
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~histotype + race, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
...
# Per education----
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~education + race, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
...
# Per cancersite----
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~cancersite +race, data = clin_surv) 
...
# CD3
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2600, .52))
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_tumor.i, data = clin_surv) 
summary(myplot)
...
## CD3 stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2600, .52))
#
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_stroma.i, data = clin_surv) 
summary(myplot)
...
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_total.i, data = clin_surv) 
summary(myplot)
...
# CD3_CD8 tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2500, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_tumor.i, data = clin_surv) 
summary(myplot)
...
# CD3_CD8 stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2500, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_stroma.i, data = clin_surv) 
summary(myplot)
...
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_total.i, data = clin_surv) 
summary(myplot)
...
# CD3_FoxP3 tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2100, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_tumor.i, data = clin_surv) 
summary(myplot)
...
# CD3_FoxP3 stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2100, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_stroma.i, data = clin_surv) 
summary(myplot)
...
# CD11b+ tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2500, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_tumor.i, data = clin_surv) 
summary(myplot)
...
# CD11b+ stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(2500, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_stroma.i, data = clin_surv) 
summary(myplot)
...
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_total.i, data = clin_surv) 
summary(myplot)
...
# CD11b+CD15+ tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(3000, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_tumor.i, data = clin_surv) 
summary(myplot)
...
# CD11b+CD15+ stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp, data = clin_surv) 
ggsurvplot(myplot, data = clin_surv,
           ...
           pval = TRUE, pval.coord = c(3000, .52))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_stroma.i, data = clin_surv) 
summary(myplot)
...
summary(myplot)
# Cox CD3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD3FoxP3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD3CD8
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3CD8t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3CD8s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD11b
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bt
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bs
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD11bCD15
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15s
...
# Black only----
clin_surv <- markers_match %>% filter(race == "Black")
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3t
...
# White only----
clin_surv <- markers_match %>% filter(race == "White")
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_grp + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3t
...
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_grp + race + averaged.CD3_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_grp + refage + race + stage + averaged.CD3_grp*race, data = clin_surv) 
summary(myplot)

# Cox CD3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3t_grp + race + averaged.CD3t_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3t_grp + refage + race + stage + averaged.CD3t_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3s_grp + race + averaged.CD3s_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3s_grp + refage + race + stage + averaged.CD3s_grp*race, data = clin_surv) 
summary(myplot)

# Cox CD3FoxP3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3_grp + race + averaged.CD3_FoxP3_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3_grp + refage + race + stage + averaged.CD3_FoxP3_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3t_grp + race + averaged.CD3_FoxP3t_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3t_grp + refage + race + stage + averaged.CD3_FoxP3t_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3s_grp + race + averaged.CD3_FoxP3s_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3s_grp + refage + race + stage + averaged.CD3_FoxP3s_grp*race, data = clin_surv) 
summary(myplot)


# Cox CD3CD8
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8_grp + race + averaged.CD3_CD8_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8_grp + refage + race + stage + averaged.CD3_CD8_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD3CD8t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8t_grp + race + averaged.CD3_CD8t_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8t_grp + refage + race + stage + averaged.CD3_CD8t_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD3CD8s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8s_grp + race + averaged.CD3_CD8s_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8s_grp + refage + race + stage + averaged.CD3_CD8s_grp*race, data = clin_surv) 
summary(myplot)

# Cox CD11b
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_grp + race + averaged.CD11b_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_grp + refage + race + stage + averaged.CD11b_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD11bt
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bt_grp + race + averaged.CD11bt_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bt_grp + refage + race + stage + averaged.CD11bt_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD11bs
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bs_grp + race + averaged.CD11bs_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bs_grp + refage + race + stage + averaged.CD11bs_grp*race, data = clin_surv) 
summary(myplot)

# Cox CD11bCD15
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15_grp + race + averaged.CD11b_CD15_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15_grp + refage + race + stage + averaged.CD11b_CD15_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15t_grp + race + averaged.CD11b_CD15t_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15t_grp + refage + race + stage + averaged.CD11b_CD15t_grp*race, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15s_grp + race + averaged.CD11b_CD15s_grp*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15s_grp + refage + race + stage + averaged.CD11b_CD15s_grp*race, data = clin_surv) 
summary(myplot)
...
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 ...
                 surv.median.line = c("hv"))
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_total.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_total.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_grp_p + race + CD3_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_grp_p + refage + race + stage + CD3_grp_p*race, data = clin_surv) 
summary(myplot)

# CD3t
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by tumoral CD3+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_tumor.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_tumor.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp_p + race + CD3t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp_p + refage + race + stage + CD3t_grp_p*race, data = clin_surv) 
summary(myplot)

## CD3 stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by stromal CD3+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
#
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_stroma.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_stroma.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp_p + race + CD3s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp_p + refage + race + stage + CD3s_grp_p*race, data = clin_surv) 
summary(myplot)

# CD3_CD8
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by overall peripheral CD3+CD8+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 legend.title = "CD3+CD8+",
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_total.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_total.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp_p + race + CD3_CD8_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp_p + refage + race + stage + CD3_CD8_grp_p*race, data = clin_surv) 
summary(myplot)

# CD3_CD8 tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by tumoral CD3+CD8+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_tumor.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_tumor.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp_p + race + CD3_CD8t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp_p + refage + race + stage + CD3_CD8t_grp_p*race, data = clin_surv) 
summary(myplot)

# CD3_CD8 stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by stromal CD3+CD8+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_stroma.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_CD8_stroma.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp_p + race + CD3_CD8s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp_p + refage + race + stage + CD3_CD8s_grp_p*race, data = clin_surv) 
summary(myplot)

# CD3_FoxP3
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by overall peripheral CD3+FoxP3+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 legend.title = "CD3+FoxP3+",
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_total.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_total.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp_p + race + CD3_FoxP3_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp_p + refage + race + stage + CD3_FoxP3_grp_p*race, data = clin_surv) 
summary(myplot)

# CD3_FoxP3 tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by tumoral CD3+FoxP3+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_tumor.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_tumor.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp_p + race + CD3_FoxP3t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp_p + refage + race + stage + CD3_FoxP3t_grp_p*race, data = clin_surv) 
summary(myplot)

# CD3_FoxP3 stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by stromal CD3+FoxP3+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_stroma.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD3_FoxP3_stroma.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp_p + race + CD3_FoxP3s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp_p + refage + race + stage + CD3_FoxP3s_grp_p*race, data = clin_surv) 
summary(myplot)

# CD11b+
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11b_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by overall peripheral CD11b+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 legend.title = "CD11b+",
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_total.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_total.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_grp_p + race + CD11b_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_grp_p + refage + race + stage + CD11b_grp_p*race, data = clin_surv) 
summary(myplot)

# CD11b+ tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by tumoral CD11b+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_tumor.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_tumor.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp_p + race + CD11bt_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp_p + refage + race + stage + CD11bt_grp_p*race, data = clin_surv) 
summary(myplot)

# CD11b+ stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by stromal CD11b+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_stroma.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_stroma.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp_p + race + CD11bs_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp_p + refage + race + stage + CD11bs_grp_p*race, data = clin_surv) 
summary(myplot)

# CD11b+CD15+
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by overall peripheral CD11b+CD15+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 legend.title = "CD11b+CD15+",
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_total.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_total.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp_p + race + CD11b_CD15_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp_p + refage + race + stage + CD11b_CD15_grp_p*race, data = clin_surv) 
summary(myplot)

# CD11b+CD15+ tumor
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by tumoral CD11b+CD15+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_tumor.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_tumor.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp_p + race + CD11b_CD15t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp_p + refage + race + stage + CD11b_CD15t_grp_p*race, data = clin_surv) 
summary(myplot)

# CD11b+CD15+ stroma
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp_p + race, data = clin_surv) 
ggsurvplot_facet(myplot, data = clin_surv, facet.by = "race",
                 title = "Survival analysis on case-matched population Black vs White \nseparated by stromal CD11b+CD15+ lymphocyte occupancy",
                 font.main = c(16, "bold", "black"),
                 xlab = "Time (days)",
                 ...
                 surv.median.line = c("hv"))
# Cox
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp_p + race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_stroma.p + race, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp_p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~percent_CD11b_CD15_stroma.p + refage + race + stage, data = clin_surv) 
summary(myplot)

myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp_p + race + CD11b_CD15s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp_p + refage + race + stage + CD11b_CD15s_grp_p*race, data = clin_surv) 
summary(myplot)
...
clin_surv <- markers_match
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3t_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3s_grp_p + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD3FoxP3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3t_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_FoxP3s_grp_p + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD3CD8
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3CD8t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8t_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD3CD8s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD3_CD8s_grp_p + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD11b
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bt
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bt_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bs
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11bs_grp_p + refage + stage, data = clin_surv) 
summary(myplot)

# Cox CD11bCD15
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15t_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~CD11b_CD15s_grp_p + refage + stage, data = clin_surv) 
summary(myplot)
...
# Extra cox with median tertile----
# Cox CD3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_grp_p + race + averaged.CD3_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_grp_p + refage + race + stage + averaged.CD3_grp_p*race, data = clin_surv) 
summary(myplot)

# Cox CD3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3t_grp_p + race + averaged.CD3t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3t_grp_p + refage + race + stage + averaged.CD3t_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3s_grp_p + race + averaged.CD3s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3s_grp_p + refage + race + stage + averaged.CD3s_grp_p*race, data = clin_surv) 
summary(myplot)

# Cox CD3FoxP3
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3_grp_p + race + averaged.CD3_FoxP3_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3_grp_p + refage + race + stage + averaged.CD3_FoxP3_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3t_grp_p + race + averaged.CD3_FoxP3t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3t_grp_p + refage + race + stage + averaged.CD3_FoxP3t_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD3FoxP3s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3s_grp_p + race + averaged.CD3_FoxP3s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_FoxP3s_grp_p + refage + race + stage + averaged.CD3_FoxP3s_grp_p*race, data = clin_surv) 
summary(myplot)


# Cox CD3CD8
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8_grp_p + race + averaged.CD3_CD8_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8_grp_p + refage + race + stage + averaged.CD3_CD8_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD3CD8t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8t_grp_p + race + averaged.CD3_CD8t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8t_grp_p + refage + race + stage + averaged.CD3_CD8t_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD3CD8s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8s_grp_p + race + averaged.CD3_CD8s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD3_CD8s_grp_p + refage + race + stage + averaged.CD3_CD8s_grp_p*race, data = clin_surv) 
summary(myplot)

# Cox CD11b
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_grp_p + race + averaged.CD11b_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_grp_p + refage + race + stage + averaged.CD11b_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD11bt
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bt_grp_p + race + averaged.CD11bt_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bt_grp_p + refage + race + stage + averaged.CD11bt_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD11bs
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bs_grp_p + race + averaged.CD11bs_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11bs_grp_p + refage + race + stage + averaged.CD11bs_grp_p*race, data = clin_surv) 
summary(myplot)

# Cox CD11bCD15
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15_grp_p + race + averaged.CD11b_CD15_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15_grp_p + refage + race + stage + averaged.CD11b_CD15_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15t
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15t_grp_p + race + averaged.CD11b_CD15t_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15t_grp_p + refage + race + stage + averaged.CD11b_CD15t_grp_p*race, data = clin_surv) 
summary(myplot)
# Cox CD11bCD15s
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15s_grp_p + race + averaged.CD11b_CD15s_grp_p*race, data = clin_surv) 
summary(myplot)
myplot <- coxph(Surv(time = timelastfu_new, event = surv_vital)~averaged.CD11b_CD15s_grp_p + refage + race + stage + averaged.CD11b_CD15s_grp_p*race, data = clin_surv) 
summary(myplot)
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3 +race, data = clin_surv) 
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD8 +race, data = clin_surv) 
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3CD8 +race, data = clin_surv) 
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~FoxP3 +race, data = clin_surv) 
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD3FoxP3 +race, data = clin_surv) 
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11b +race, data = clin_surv) 
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD15 +race, data = clin_surv) 
...
myplot <- survfit(Surv(time = timelastfu_new, event = surv_vital)~CD11bCD15 +race, data = clin_surv) 
